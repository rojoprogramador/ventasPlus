    ...
    <nav class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
          <div class="flex">
            ...
            <div class="flex-shrink-0 flex items-center">
              <Link :href="$page.props.ziggy.routes.dashboard" class="text-xl font-bold text-gray-800">
                Ventas Plus
              </Link>
            </div>
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
              ...
              <NavLink :href="$page.props.ziggy.routes['ventas.index']" :active="$page.url === '/ventas'">
                Ventas
              </NavLink>
            </div>
          </div>
      ...
      <div :class="{'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown}" class="sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
          ...
          <ResponsiveNavLink :href="$page.props.ziggy.routes['ventas.index']" :active="$page.url === '/ventas'">
            Ventas
          </ResponsiveNavLink>
        </div>
      </div>
...
const currentPath = computed(() => usePage().props.ziggy.location)

const isActive = (routeName) => {
    return currentPath.value === usePage().props.ziggy.routes[routeName]
}
</script>
